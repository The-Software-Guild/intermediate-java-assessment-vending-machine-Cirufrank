 ...
 * 
 * @description This interface declares the method responsible for the
 * Vending Machine Bank business logic of our application
 */
public interface VendingMachineBankServiceLayer {
    /**
